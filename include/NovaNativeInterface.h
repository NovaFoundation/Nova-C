...
#include <compiler/tree/node/compiler_tree_node_Nova_NovaInterface.h>
...
#include <compiler/tree/node/compiler_tree_node_Nova_Skeleton.h>
...
#include <compiler/tree/node/generics/compiler_tree_node_generics_Nova_GenericTypeArgument.h>
...
typedef int (*nova_Nova_String_native1_Nova_indexOf)(nova_Nova_String*, nova_exception_Nova_ExceptionData*, nova_Nova_String*, int, int, int);
...
nova_Nova_String_native1_Nova_indexOf indexOf__nova_String__nova_primitive_number_Int__nova_primitive_number_Int__nova_primitive_number_Int;
...
typedef compiler_Nova_SyntaxErrorException* (*compiler_Nova_SyntaxErrorException_native1_Nova_construct)(compiler_Nova_SyntaxErrorException*, nova_exception_Nova_ExceptionData*, nova_Nova_String*, compiler_tree_node_Nova_Node*, compiler_tree_node_Nova_Program*);
...
compiler_Nova_SyntaxErrorException_native1_Nova_construct SyntaxErrorException__nova_String__compiler_tree_node_Node__compiler_tree_node_Program;
} compiler_native_SyntaxErrorException;

typedef void (*compiler_Nova_SyntaxMessage_native_static_Nova_errorIf)(compiler_Nova_SyntaxMessage*, nova_exception_Nova_ExceptionData*, nova_Nova_String*, compiler_tree_node_Nova_Node*, char, int);
typedef void (*compiler_Nova_SyntaxMessage_native_static_Nova_error)(compiler_Nova_SyntaxMessage*, nova_exception_Nova_ExceptionData*, nova_Nova_String*, compiler_tree_node_Nova_Node*, int);
...
typedef nova_Nova_String* (*compiler_tree_node_Nova_Abstractable_native_Nova_writeAbstract)(compiler_tree_node_Nova_Abstractable*, nova_exception_Nova_ExceptionData*);

typedef struct compiler_tree_node_native_Abstractable
{
compiler_tree_node_Nova_Abstractable_native_Nova_writeAbstract writeAbstract;
} compiler_tree_node_native_Abstractable;

typedef compiler_tree_node_Nova_Accessible* (*compiler_tree_node_Nova_Accessible_native0_Nova_getNextAccessingOfType)(compiler_tree_node_Nova_Accessible*, nova_exception_Nova_ExceptionData*, nova_Nova_Class*);
typedef compiler_tree_node_Nova_Accessible* (*compiler_tree_node_Nova_Accessible_native1_Nova_getNextAccessingOfType)(compiler_tree_node_Nova_Accessible*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_Array*);
typedef compiler_tree_node_Nova_Accessible* (*compiler_tree_node_Nova_Accessible_native2_Nova_getNextAccessingOfType)(compiler_tree_node_Nova_Accessible*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_Array*, char);
typedef compiler_tree_node_Nova_Accessible* (*compiler_tree_node_Nova_Accessible_native0_Nova_getLastAccessingOfType)(compiler_tree_node_Nova_Accessible*, nova_exception_Nova_ExceptionData*, nova_Nova_Class*, char, int);
typedef compiler_tree_node_Nova_Accessible* (*compiler_tree_node_Nova_Accessible_native1_Nova_getLastAccessingOfType)(compiler_tree_node_Nova_Accessible*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_Array*, char, int);
typedef compiler_tree_node_Nova_Accessible* (*compiler_tree_node_Nova_Accessible_native0_Nova_getLastAccessedOfType)(compiler_tree_node_Nova_Accessible*, nova_exception_Nova_ExceptionData*, nova_Nova_Class*, char);
typedef compiler_tree_node_Nova_Accessible* (*compiler_tree_node_Nova_Accessible_native1_Nova_getLastAccessedOfType)(compiler_tree_node_Nova_Accessible*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_Array*, char);
typedef compiler_tree_node_Nova_Accessible* (*compiler_tree_node_Nova_Accessible_native_Nova_getLastAccessed)(compiler_tree_node_Nova_Accessible*, nova_exception_Nova_ExceptionData*);
typedef compiler_tree_node_Nova_Identifier* (*compiler_tree_node_Nova_Accessible_native0_Nova_getNextAccessedOfType)(compiler_tree_node_Nova_Accessible*, nova_exception_Nova_ExceptionData*, nova_Nova_Class*);
typedef compiler_tree_node_Nova_Identifier* (*compiler_tree_node_Nova_Accessible_native1_Nova_getNextAccessedOfType)(compiler_tree_node_Nova_Accessible*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_Array*);
typedef compiler_tree_node_Nova_Accessible* (*compiler_tree_node_Nova_Accessible_native_Nova_getRootReferenceNode)(compiler_tree_node_Nova_Accessible*, nova_exception_Nova_ExceptionData*, int);
typedef compiler_tree_node_Nova_Accessible* (*compiler_tree_node_Nova_Accessible_native_Nova_getReferenceNode)(compiler_tree_node_Nova_Accessible*, nova_exception_Nova_ExceptionData*, int, int);

typedef struct compiler_tree_node_native_Accessible
{
compiler_tree_node_Nova_Accessible_native0_Nova_getNextAccessingOfType getNextAccessingOfType__nova_Class;
compiler_tree_node_Nova_Accessible_native1_Nova_getNextAccessingOfType getNextAccessingOfType__nova_datastruct_list_Array;
compiler_tree_node_Nova_Accessible_native2_Nova_getNextAccessingOfType getNextAccessingOfType__nova_datastruct_list_Array__nova_primitive_Bool;
compiler_tree_node_Nova_Accessible_native0_Nova_getLastAccessingOfType getLastAccessingOfType__nova_Class__nova_primitive_Bool__nova_primitive_Bool;
compiler_tree_node_Nova_Accessible_native1_Nova_getLastAccessingOfType getLastAccessingOfType__nova_datastruct_list_Array__nova_primitive_Bool__nova_primitive_Bool;
compiler_tree_node_Nova_Accessible_native0_Nova_getLastAccessedOfType getLastAccessedOfType__nova_Class__nova_primitive_Bool;
compiler_tree_node_Nova_Accessible_native1_Nova_getLastAccessedOfType getLastAccessedOfType__nova_datastruct_list_Array__nova_primitive_Bool;
compiler_tree_node_Nova_Accessible_native_Nova_getLastAccessed getLastAccessed;
compiler_tree_node_Nova_Accessible_native0_Nova_getNextAccessedOfType getNextAccessedOfType__nova_Class;
compiler_tree_node_Nova_Accessible_native1_Nova_getNextAccessedOfType getNextAccessedOfType__nova_datastruct_list_Array;
compiler_tree_node_Nova_Accessible_native_Nova_getRootReferenceNode getRootReferenceNode;
compiler_tree_node_Nova_Accessible_native_Nova_getReferenceNode getReferenceNode;
} compiler_tree_node_native_Accessible;

typedef compiler_tree_node_Nova_Identifier* (*compiler_tree_node_Nova_Identifier_native_static_Nova_tryParse)(compiler_tree_node_Nova_Identifier*, nova_exception_Nova_ExceptionData*, nova_Nova_String*, compiler_tree_node_Nova_Node*, compiler_util_Nova_Location*, int);
typedef compiler_tree_node_Nova_Identifier* (*compiler_tree_node_Nova_Identifier_native_Nova_construct)(compiler_tree_node_Nova_Identifier*, nova_exception_Nova_ExceptionData*, compiler_tree_node_Nova_Node*, compiler_util_Nova_Location*);

typedef struct compiler_tree_node_native_Identifier
{
compiler_tree_node_Nova_Identifier_native_Nova_construct Identifier;
} compiler_tree_node_native_Identifier;
...
typedef compiler_tree_node_Nova_Import* (*compiler_tree_node_Nova_Import_native_static_Nova_tryParse)(compiler_tree_node_Nova_Import*, nova_exception_Nova_ExceptionData*, nova_Nova_String*, compiler_tree_node_Nova_Node*, compiler_util_Nova_Location*, int);
typedef compiler_tree_node_Nova_Import* (*compiler_tree_node_Nova_Import_native_Nova_construct)(compiler_tree_node_Nova_Import*, nova_exception_Nova_ExceptionData*, compiler_tree_node_Nova_Node*, compiler_util_Nova_Location*);
...
typedef void (*compiler_tree_node_Nova_Node_native_Nova_onChildDetached)(compiler_tree_node_Nova_Node*, nova_exception_Nova_ExceptionData*, compiler_tree_node_Nova_Node*);
...
compiler_tree_node_Nova_Node_native_Nova_onChildDetached onChildDetached;
...
typedef void (*compiler_tree_node_Nova_NodeList_native_Nova_replace)(compiler_tree_node_Nova_NodeList*, nova_exception_Nova_ExceptionData*, compiler_tree_node_Nova_Node*, compiler_tree_node_Nova_Node*, int);
typedef compiler_tree_node_Nova_Node* (*compiler_tree_node_Nova_NodeList_native_Nova_addChild)(compiler_tree_node_Nova_NodeList*, nova_exception_Nova_ExceptionData*, compiler_tree_node_Nova_Node*, int, int);
typedef char (*compiler_tree_node_Nova_NodeList_native_Nova_containsChild)(compiler_tree_node_Nova_NodeList*, nova_exception_Nova_ExceptionData*, compiler_tree_node_Nova_Node*, int);
typedef nova_datastruct_list_Nova_Array* (*compiler_tree_node_Nova_NodeList_native_Nova_inheritChildren)(compiler_tree_node_Nova_NodeList*, nova_exception_Nova_ExceptionData*, compiler_tree_node_Nova_NodeList*, int);
typedef compiler_tree_node_Nova_Node* (*compiler_tree_node_Nova_NodeList_native0_Nova_removeChild)(compiler_tree_node_Nova_NodeList*, nova_exception_Nova_ExceptionData*, compiler_tree_node_Nova_Node*);
typedef compiler_tree_node_Nova_Node* (*compiler_tree_node_Nova_NodeList_native1_Nova_removeChild)(compiler_tree_node_Nova_NodeList*, nova_exception_Nova_ExceptionData*, int);
typedef nova_datastruct_list_Nova_Array* (*compiler_tree_node_Nova_NodeList_native_Nova_slaughterChildren)(compiler_tree_node_Nova_NodeList*, nova_exception_Nova_ExceptionData*);
typedef compiler_tree_node_Nova_NodeList* (*compiler_tree_node_Nova_NodeList_native_Nova_construct)(compiler_tree_node_Nova_NodeList*, nova_exception_Nova_ExceptionData*, compiler_tree_node_Nova_Node*, compiler_util_Nova_Location*);

typedef struct compiler_tree_node_native_NodeList
{
compiler_tree_node_Nova_NodeList_native_Nova_replace replace;
compiler_tree_node_Nova_NodeList_native_Nova_addChild addChild;
compiler_tree_node_Nova_NodeList_native_Nova_containsChild containsChild;
compiler_tree_node_Nova_NodeList_native_Nova_inheritChildren inheritChildren;
compiler_tree_node_Nova_NodeList_native0_Nova_removeChild removeChild__compiler_tree_node_Node;
compiler_tree_node_Nova_NodeList_native1_Nova_removeChild removeChild__nova_primitive_number_Int;
compiler_tree_node_Nova_NodeList_native_Nova_slaughterChildren slaughterChildren;
compiler_tree_node_Nova_NodeList_native_Nova_construct NodeList;
} compiler_tree_node_native_NodeList;

typedef compiler_tree_node_Nova_NovaClass* (*compiler_tree_node_Nova_NovaClass_native_static_Nova_tryParse)(compiler_tree_node_Nova_NovaClass*, nova_exception_Nova_ExceptionData*, nova_Nova_String*, compiler_tree_node_Nova_Node*, compiler_util_Nova_Location*, int);
typedef char (*compiler_tree_node_Nova_NovaClass_native_Nova_parseModifier)(compiler_tree_node_Nova_NovaClass*, nova_exception_Nova_ExceptionData*, nova_Nova_String*);
typedef nova_Nova_String* (*compiler_tree_node_Nova_NovaClass_native_Nova_writeAbstract)(compiler_tree_node_Nova_NovaClass*, nova_exception_Nova_ExceptionData*);
typedef nova_Nova_String* (*compiler_tree_node_Nova_NovaClass_native_Nova_writeModifiers)(compiler_tree_node_Nova_NovaClass*, nova_exception_Nova_ExceptionData*);
typedef nova_Nova_String* (*compiler_tree_node_Nova_NovaClass_native_Nova_writeExtension)(compiler_tree_node_Nova_NovaClass*, nova_exception_Nova_ExceptionData*);
typedef nova_Nova_String* (*compiler_tree_node_Nova_NovaClass_native_Nova_writeImplementedInterfaces)(compiler_tree_node_Nova_NovaClass*, nova_exception_Nova_ExceptionData*);
typedef nova_Nova_String* (*compiler_tree_node_Nova_NovaClass_native_Nova_toString)(compiler_tree_node_Nova_NovaClass*, nova_exception_Nova_ExceptionData*);
typedef compiler_tree_node_Nova_NovaClass* (*compiler_tree_node_Nova_NovaClass_native_Nova_construct)(compiler_tree_node_Nova_NovaClass*, nova_exception_Nova_ExceptionData*, compiler_tree_node_Nova_Node*, compiler_util_Nova_Location*);

typedef struct compiler_tree_node_native_NovaClass
{
compiler_tree_node_Nova_NovaClass_native_Nova_parseModifier parseModifier;
compiler_tree_node_Nova_NovaClass_native_Nova_writeAbstract writeAbstract;
compiler_tree_node_Nova_NovaClass_native_Nova_writeModifiers writeModifiers;
compiler_tree_node_Nova_NovaClass_native_Nova_writeExtension writeExtension;
compiler_tree_node_Nova_NovaClass_native_Nova_writeImplementedInterfaces writeImplementedInterfaces;
compiler_tree_node_Nova_NovaClass_native_Nova_toString toString;
...
typedef compiler_tree_node_Nova_NovaInterface* (*compiler_tree_node_Nova_NovaInterface_native_Nova_construct)(compiler_tree_node_Nova_NovaInterface*, nova_exception_Nova_ExceptionData*);

typedef struct compiler_tree_node_native_NovaInterface
{
compiler_tree_node_Nova_NovaInterface_native_Nova_construct NovaInterface;
} compiler_tree_node_native_NovaInterface;
...
typedef compiler_tree_node_Nova_Program* (*compiler_tree_node_Nova_Program_native_Nova_construct)(compiler_tree_node_Nova_Program*, nova_exception_Nova_ExceptionData*, compiler_Nova_Compiler*);
...
typedef compiler_tree_node_Nova_Scope* (*compiler_tree_node_Nova_Scope_native_Nova_construct)(compiler_tree_node_Nova_Scope*, nova_exception_Nova_ExceptionData*, compiler_tree_node_Nova_Node*, compiler_util_Nova_Location*);
...
typedef compiler_tree_node_Nova_Skeleton* (*compiler_tree_node_Nova_Skeleton_native_static_Nova_tryParse)(compiler_tree_node_Nova_Skeleton*, nova_exception_Nova_ExceptionData*, nova_Nova_String*, compiler_tree_node_Nova_Node*, compiler_util_Nova_Location*, int);
typedef compiler_tree_node_Nova_Skeleton* (*compiler_tree_node_Nova_Skeleton_native_Nova_construct)(compiler_tree_node_Nova_Skeleton*, nova_exception_Nova_ExceptionData*, compiler_tree_node_Nova_Node*, compiler_util_Nova_Location*);

typedef struct compiler_tree_node_native_Skeleton
{
compiler_tree_node_Nova_Skeleton_native_Nova_construct Skeleton;
} compiler_tree_node_native_Skeleton;
...
typedef compiler_tree_node_Nova_Value* (*compiler_tree_node_Nova_Value_native_Nova_construct)(compiler_tree_node_Nova_Value*, nova_exception_Nova_ExceptionData*);

typedef struct compiler_tree_node_native_Value
{
compiler_tree_node_Nova_Value_native_Nova_construct Value;
} compiler_tree_node_native_Value;
...
typedef compiler_tree_node_arrays_Nova_ArrayAccess* (*compiler_tree_node_arrays_Nova_ArrayAccess_native_Nova_tryParse)(compiler_tree_node_arrays_Nova_ArrayAccess*, nova_exception_Nova_ExceptionData*, nova_Nova_String*, compiler_tree_node_Nova_Node*, compiler_util_Nova_Location*, int);
typedef compiler_tree_node_arrays_Nova_ArrayAccess* (*compiler_tree_node_arrays_Nova_ArrayAccess_native_Nova_construct)(compiler_tree_node_arrays_Nova_ArrayAccess*, nova_exception_Nova_ExceptionData*, compiler_tree_node_Nova_Node*, compiler_util_Nova_Location*);

typedef struct compiler_tree_node_arrays_native_ArrayAccess
{
compiler_tree_node_arrays_Nova_ArrayAccess_native_Nova_tryParse tryParse;
compiler_tree_node_arrays_Nova_ArrayAccess_native_Nova_construct ArrayAccess;
} compiler_tree_node_arrays_native_ArrayAccess;
...
typedef compiler_tree_node_generics_Nova_GenericTypeArgument* (*compiler_tree_node_generics_Nova_GenericTypeArgument_native_Nova_construct)(compiler_tree_node_generics_Nova_GenericTypeArgument*, nova_exception_Nova_ExceptionData*);

typedef struct compiler_tree_node_generics_native_GenericTypeArgument
{
compiler_tree_node_generics_Nova_GenericTypeArgument_native_Nova_construct GenericTypeArgument;
} compiler_tree_node_generics_native_GenericTypeArgument;

typedef compiler_tree_node_operations_Nova_Operator* (*compiler_tree_node_operations_Nova_Operator_native_Nova_construct)(compiler_tree_node_operations_Nova_Operator*, nova_exception_Nova_ExceptionData*);

typedef struct compiler_tree_node_operations_native_Operator
{
compiler_tree_node_operations_Nova_Operator_native_Nova_construct Operator;
} compiler_tree_node_operations_native_Operator;

typedef compiler_tree_node_operations_Nova_UnaryOperation* (*compiler_tree_node_operations_Nova_UnaryOperation_native_Nova_construct)(compiler_tree_node_operations_Nova_UnaryOperation*, nova_exception_Nova_ExceptionData*);

typedef struct compiler_tree_node_operations_native_UnaryOperation
{
compiler_tree_node_operations_Nova_UnaryOperation_native_Nova_construct UnaryOperation;
} compiler_tree_node_operations_native_UnaryOperation;

typedef compiler_tree_node_variables_Nova_InstanceDeclaration* (*compiler_tree_node_variables_Nova_InstanceDeclaration_native_static_Nova_tryParse)(compiler_tree_node_variables_Nova_InstanceDeclaration*, nova_exception_Nova_ExceptionData*, nova_Nova_String*, compiler_tree_node_Nova_Node*, compiler_util_Nova_Location*, int);
typedef char (*compiler_tree_node_variables_Nova_InstanceDeclaration_native_Nova_parseModifier)(compiler_tree_node_variables_Nova_InstanceDeclaration*, nova_exception_Nova_ExceptionData*, nova_Nova_String*);
typedef nova_Nova_String* (*compiler_tree_node_variables_Nova_InstanceDeclaration_native_Nova_writeVisibility)(compiler_tree_node_variables_Nova_InstanceDeclaration*, nova_exception_Nova_ExceptionData*);
typedef nova_Nova_String* (*compiler_tree_node_variables_Nova_InstanceDeclaration_native_Nova_writeStatic)(compiler_tree_node_variables_Nova_InstanceDeclaration*, nova_exception_Nova_ExceptionData*);
typedef nova_Nova_String* (*compiler_tree_node_variables_Nova_InstanceDeclaration_native_Nova_writeModifiers)(compiler_tree_node_variables_Nova_InstanceDeclaration*, nova_exception_Nova_ExceptionData*);
typedef compiler_tree_node_variables_Nova_InstanceDeclaration* (*compiler_tree_node_variables_Nova_InstanceDeclaration_native_Nova_construct)(compiler_tree_node_variables_Nova_InstanceDeclaration*, nova_exception_Nova_ExceptionData*, compiler_tree_node_Nova_Node*, compiler_util_Nova_Location*);

typedef struct compiler_tree_node_variables_native_InstanceDeclaration
{
compiler_tree_node_variables_Nova_InstanceDeclaration_native_Nova_parseModifier parseModifier;
compiler_tree_node_variables_Nova_InstanceDeclaration_native_Nova_writeVisibility writeVisibility;
compiler_tree_node_variables_Nova_InstanceDeclaration_native_Nova_writeStatic writeStatic;
compiler_tree_node_variables_Nova_InstanceDeclaration_native_Nova_writeModifiers writeModifiers;
compiler_tree_node_variables_Nova_InstanceDeclaration_native_Nova_construct InstanceDeclaration;
} compiler_tree_node_variables_native_InstanceDeclaration;

typedef compiler_tree_node_variables_Nova_VariableDeclaration* (*compiler_tree_node_variables_Nova_VariableDeclaration_native_static_Nova_tryParse)(compiler_tree_node_variables_Nova_VariableDeclaration*, nova_exception_Nova_ExceptionData*, nova_Nova_String*, compiler_tree_node_Nova_Node*, compiler_util_Nova_Location*, int);
typedef char (*compiler_tree_node_variables_Nova_VariableDeclaration_native_Nova_parseModifier)(compiler_tree_node_variables_Nova_VariableDeclaration*, nova_exception_Nova_ExceptionData*, nova_Nova_String*);
typedef char (*compiler_tree_node_variables_Nova_VariableDeclaration_native_Nova_parseModifiers)(compiler_tree_node_variables_Nova_VariableDeclaration*, nova_exception_Nova_ExceptionData*, nova_Nova_String*);
typedef nova_datastruct_list_Nova_Array* (*compiler_tree_node_variables_Nova_VariableDeclaration_native_Nova_getInvalidModifiers)(compiler_tree_node_variables_Nova_VariableDeclaration*, nova_exception_Nova_ExceptionData*, nova_Nova_String*);
typedef compiler_tree_node_variables_Nova_VariableDeclaration* (*compiler_tree_node_variables_Nova_VariableDeclaration_native_Nova_construct)(compiler_tree_node_variables_Nova_VariableDeclaration*, nova_exception_Nova_ExceptionData*, compiler_tree_node_Nova_Node*, compiler_util_Nova_Location*);

typedef struct compiler_tree_node_variables_native_VariableDeclaration
{
compiler_tree_node_variables_Nova_VariableDeclaration_native_Nova_parseModifier parseModifier;
compiler_tree_node_variables_Nova_VariableDeclaration_native_Nova_parseModifiers parseModifiers;
compiler_tree_node_variables_Nova_VariableDeclaration_native_Nova_getInvalidModifiers getInvalidModifiers;
compiler_tree_node_variables_Nova_VariableDeclaration_native_Nova_construct VariableDeclaration;
} compiler_tree_node_variables_native_VariableDeclaration;
...
typedef int (*compiler_util_Nova_CompilerStringFunctions_native_Nova_nextNonWhitespaceIndex)(nova_Nova_String*, nova_exception_Nova_ExceptionData*, int, int);
typedef int (*compiler_util_Nova_CompilerStringFunctions_native_Nova_nextWhitespaceIndex)(nova_Nova_String*, nova_exception_Nova_ExceptionData*, int, int);
typedef int (*compiler_util_Nova_CompilerStringFunctions_native_Nova_nextIndexThatContains)(nova_Nova_String*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_CharArray*, int, int, int);
...
typedef nova_datastruct_list_Nova_Array* (*compiler_util_Nova_CompilerStringFunctions_native_Nova_splitCommas)(nova_Nova_String*, nova_exception_Nova_ExceptionData*, int, int);
...
typedef int (*compiler_util_Nova_CompilerStringFunctions_native_Nova_findStringInBaseScope)(nova_Nova_String*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_Array*, int, int, int);
...
compiler_util_Nova_CompilerStringFunctions_native_Nova_splitCommas splitCommas;
...
compiler_util_Nova_CompilerStringFunctions_native_Nova_findStringInBaseScope findStringInBaseScope;
...
typedef void (*stabilitytest_Nova_RegexStability_native_Nova_test)(stabilitytest_Nova_RegexStability*, nova_exception_Nova_ExceptionData*);
...
{
stabilitytest_Nova_RegexStability_native_Nova_test test;
...
compiler_tree_node_native_Abstractable compiler_tree_node_Abstractable;
compiler_tree_node_native_Accessible compiler_tree_node_Accessible;
compiler_tree_node_native_Identifier compiler_tree_node_Identifier;
...
compiler_tree_node_native_NovaInterface compiler_tree_node_NovaInterface;
...
compiler_tree_node_native_Skeleton compiler_tree_node_Skeleton;
compiler_tree_node_native_ValidationResult compiler_tree_node_ValidationResult;
compiler_tree_node_native_Value compiler_tree_node_Value;
...
compiler_tree_node_arrays_native_ArrayAccess compiler_tree_node_arrays_ArrayAccess;
...
compiler_tree_node_generics_native_GenericTypeArgument compiler_tree_node_generics_GenericTypeArgument;
compiler_tree_node_operations_native_Operator compiler_tree_node_operations_Operator;
compiler_tree_node_operations_native_UnaryOperation compiler_tree_node_operations_UnaryOperation;
compiler_tree_node_variables_native_InstanceDeclaration compiler_tree_node_variables_InstanceDeclaration;
compiler_tree_node_variables_native_VariableDeclaration compiler_tree_node_variables_VariableDeclaration;
